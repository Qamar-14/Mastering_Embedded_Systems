...
void KEYPAD_INIT(void)
{
	...
	/*MCAL_GPIO_SET_PIN_INPUT(KEYPAD_PORT, R0, GPIO_MODE_INPUT_FLOATING);
	MCAL_GPIO_SET_PIN_INPUT(KEYPAD_PORT, R1, GPIO_MODE_INPUT_FLOATING);
	MCAL_GPIO_SET_PIN_INPUT(KEYPAD_PORT, R2, GPIO_MODE_INPUT_FLOATING);
	MCAL_GPIO_SET_PIN_INPUT(KEYPAD_PORT, R3, GPIO_MODE_INPUT_FLOATING);*/
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, R0, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, R1, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, R2, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, R3, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);


	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, C0, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, C1, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, C2, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
	MCAL_GPIO_SET_PIN_OUTPUT(KEYPAD_PORT, C3, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_10MHZ);
