...
Src/STM32F103C_Drivers/MCAL_Drivers/GPIO_DRIVER/gpio.o: ../Src/STM32F103C_Drivers/MCAL_Drivers/GPIO_DRIVER/gpio.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -c -I../Inc -Os -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/STM32F103C_Drivers/MCAL_Drivers/GPIO_DRIVER/gpio.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
