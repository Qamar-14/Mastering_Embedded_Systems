...
#define SPI_FRAME_FORMAT_MSB 				 (uint16_t)(0x00000000U)
...
#define SPI_DATA_SIZE_8B 				 (uint16_t)(0x00000000U)
#define SPI_DATA_SIZE_16B  				 (uint16_t)(0x1U<<11)
...
#define SPI_CLKPOLARITY_LOW_WHEN_IDLE			 (uint16_t)(0x00000000U)
#define SPI_CLKPOLARITY_HIGH_WHEN_IDLE 			 (uint16_t)(0x1U<<1) //CR1 bit 1 CPOL selected
...
#define SPI_CLKPHASE_2EDGE_FIRST_DATA_CAPTURE_EDGE 	 (uint16_t)(0x1U<<0) //CR1 bit 1 CPHA selected
